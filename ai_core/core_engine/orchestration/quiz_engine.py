    ...
    *,
    ...
    return (
       ...
       "Rules:\n"
        ...
        "- Use exactly 4 options per question. 'options' MUST be an array of strings.\n"
        "- FATAL ERROR WARNING: 'correct_answer' MUST be a simple string containing ONLY the letter (e.g. \"A\", \"B\", \"C\", or \"D\"). DO NOT use a nested object or dictionary for 'correct_answer'.\n"
